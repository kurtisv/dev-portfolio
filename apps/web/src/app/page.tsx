...
export default async function Home() {
  ...
  const signature = {
    ...
    fr: {
      availability: "Disponible pour projets produit ciblés",
      cockpit: "Cockpit recruteur",
      branch: "Branches par étape",
      shipped: "Builds live",
      proof: "Chemin de revue",
      motion: "Motion sobre, preuves lisibles, structure accessible.",
      route: "Inspecter le travail",
      quality: ["Contenu typé", "Déploiements production", "Revue FR/EN"],
      rail: "Surface portfolio",
      railLive: "Live",
      railDetails: "Détails",
      testSystem: "Tester le système",
      testEyebrow: "Plan de test recruteur",
      testTitle: "Ouvrir Luma Studio et voir comment le point d'entrée marketing public est construit.",
      testText:
        "Le portfolio met en avant Luma Studio comme démo marketing principale, aux côtés des vrais sites clients lancés.",
      testLive: "Ouvrir live",
      testDetails: "Fiche projet",
      testSignal: "À vérifier",
      reset: "Reset demo scenario",
      scenario: "Démo interactive",
      scenarioName: "KV Portfolio Demo Flow",
      ...
      scenarioBudget: "Utilise ta propre plage budgétaire",
      testSteps: [
        "Ouvrir Luma Studio, inspecter la structure marketing bilingue, le formulaire contact validé et le build déployé.",
      ],
      boilerplateEyebrow: "Créé depuis mon boilerplate",
      boilerplateTitle: "Ces sites portfolio partent de la même fondation réutilisable.",
      boilerplateText:
        "Luma Studio, SpeedZone et ce portfolio partent tous du même boilerplate Next.js. Inspecte le repo de base et compare comment la même fondation devient trois produits distincts.",
