...
const copy = {
  ...
  fr: {
    ...
    skillsTitle: "La fiabilité terrain d'un côté, des produits web livrés de l'autre.",
    languagesTitle: "Langues",
    principlesEyebrow: "Ma façon de travailler",
    principlesTitle: "La même discipline sur le terrain et dans le code.",
    cvCta: "Voir le CV",
    contactCta: "Contact",
  },
} as const;
